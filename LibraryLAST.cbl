******************************************************************
      ...
      *> Convert borrow date into integer days (悛榍压氛杌穴ㄘ貉�)
      ...
      *> RETURN-DATE ㄐ嗷绻茄狗砧っ骸铀勾ぷ� 淞桡 "NULL"
      ...
      *> History - Show borrow and return history
                   ...
                   READ BORROW-FILE
                       ...
                       NOT AT END
                           IF BORROW-MEM-ID = USER-MEM-ID
                               ...
                               *> 得迁释恒逛颗� RETURN 氰宜寡淄嗯枇拐槎佟ぷ贯砰撬米吐学
       ...
       CHECK-IF-RETURNED.
           ...
           *> Reset EOF flag 伺学ㄒ°б� CHECK-IF-RETURNED
           MOVE "N" TO WS-EOF-FLAG.
